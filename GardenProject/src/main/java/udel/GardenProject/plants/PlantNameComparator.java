...
public class PlantNameComparator implements Comparator<Plant>{
	...
	/**
	 * By default, assume sorting a list of plants alphabetically by first common name, A to Z.
	 */
	...
	/**
	 * Sort a list of plants alphabetically by first common name and specify whether it is A to Z(true) or Z to A(false)
	 * 
