...
public class View {
	 ...
	 * @return The string used in the .getStyle method to turn the background dark green
	 */
	 ...
	 * @return The string used in the .getStyle method to turn the background light green
	 */
	...
	/**
	 * The string used in the getResourceAsStream function to set the font to Hack-Bold
	 */
	...
	/**
	 * The string used in the getResourceAsStream function to set the font to Hack-Italic
	 */
