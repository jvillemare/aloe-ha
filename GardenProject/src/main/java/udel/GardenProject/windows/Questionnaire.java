...
public class Questionnaire extends Window {
	...
	/**
	 * For saving all of the user's questionnaire answers
	 * And moving between screens
	 */
	private Button backToExistingPlants, save, toPlotDesign;
	
	/**
	 * Used for the text in the VBox
	 * Info text
	 */
	...
	public CheckBox q3checkBox1, q3checkBox2, q3checkBox3, q3checkBox4, q3checkBox5, q3checkBox6, q3checkBox7, q3checkBox8, q3checkBox9, q3checkBox10;
	public CheckBox q7checkBox1, q7checkBox2, q7checkBox3, q7checkBox4, q7checkBox5;
	public CheckBox q8checkBox1, q8checkBox2, q8checkBox3, q8checkBox4, q8checkBox5, q8checkBox6, q8checkBox7, q8checkBox8;
	...
	public Questionnaire(Model m) {
		...
		text = new Text("Welcome to the Aloe-ha questionnaire! Please fill out the questions below. Remember, you must answer all of the questions to continue.\n");
		...
		ObservableList<CheckBox> q2items = FXCollections.observableArrayList(q3checkBox1, q3checkBox2, q3checkBox3, q3checkBox4, q3checkBox5, q3checkBox6, q3checkBox7, q3checkBox8, q3checkBox9, q3checkBox10);
		...
		q4ChoiceBox.getItems().addAll("Dry", "Dry-moist", "Moist", "Moist-damp", "Damp", "My plot has different moisture");
		...
		q5ChoiceBox.getItems().addAll("Peaty", "Loamy", "Sandy", "Chalky", "Clay", "Silty", "My plot has different soil types");
		...
		q6ChoiceBox.getItems().addAll("Full-sun", "Partial-shade", "Partial-sun", "Full-shade", "My plot receives different levels of sunlight");
		...
		ObservableList<CheckBox> q7items = FXCollections.observableArrayList(q7checkBox1, q7checkBox2, q7checkBox3, q7checkBox4, q7checkBox5);
		...
		ObservableList<CheckBox> q8items = FXCollections.observableArrayList(q8checkBox1, q8checkBox2, q8checkBox3, q8checkBox4, q8checkBox5, q8checkBox6, q8checkBox7, q8checkBox8);
		q8ListView.setItems(q8items);
		q8ListView.getSelectionModel().setSelectionMode(SelectionMode.MULTIPLE);
	
		vbox.setPadding(new Insets(10, 10, 10, 10));
		vbox.getChildren().addAll(text, q0, hbname, q1, hbwidth, hbheight, q2, q2ListView, q3, q3ListView, q4, q4ChoiceBox, q5, q5ChoiceBox, q6, q6ChoiceBox, q7, q7ListView, q8, q8ListView);
	...
	/*
	 * TODO: change function so it gets all the answers at the same time 
	 * This function will be used in save.setOnAction
	 */
