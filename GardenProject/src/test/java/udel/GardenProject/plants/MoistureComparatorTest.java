...
public class MoistureComparatorTest {
	...
	public void sameMoistureTest() {
		MoistureComparator c = new MoistureComparator(true);
		Plant pine = new Plant(null, null, null, null, 0, Moisture.DRY, null, Canopy.FLOOR, false, false, null);
		Plant flower = new Plant(null, null, null, null, 0, Moisture.DRY, null, Canopy.FLOOR, false, false, null);
	...
	public void ascendMoistureTest() {
		...
		Plant pine = new Plant(null, null, null, null, 0, Moisture.DRY, null, Canopy.FLOOR, false, false, null);
		Plant flower = new Plant(null, null, null, null, 0, Moisture.MOIST, null, Canopy.FLOOR, false, false, null);
		assertTrue(c.compare(pine, flower) < 0);
	}
