...
public class CanopyComparatorTest {
	...
	public void sameCanopyTest() {
		CanopyComparator c = new CanopyComparator(true);
		Plant pine = new Plant(null, null, null, null, 0, null, null, Canopy.FLOOR, false, false, null);
		Plant flower = new Plant(null, null, null, null, 0, null, null, Canopy.FLOOR, false, false, null);
	...
	public void descendTest() {
		CanopyComparator c = new CanopyComparator(true);
		Plant pine = new Plant(null, null, null, null, 0, null, null, Canopy.EMERGENT, false, false, null);
		Plant flower = new Plant(null, null, null, null, 0, null, null, Canopy.FLOOR, false, false, null);
		assertTrue(c.compare(pine, flower) < 0);
	}
	...
	public void ascendTest() {
		...
		Plant pine = new Plant(null, null, null, null, 0, null, null, Canopy.FLOOR, false, false, null);
		Plant flower = new Plant(null, null, null, null, 0, null, null, Canopy.EMERGENT, false, false, null);
		assertTrue(c.compare(pine, flower) < 0);
	}
